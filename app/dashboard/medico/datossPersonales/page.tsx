...
const Personalinfo = () => {
    ...
    const buscarDatos = () => {
        ...
        axios.get(`http://localhost:8080/medico/datossPersonales/${documento}`)
            .then(response => {
    ...
    return (
        <div className="flex flex-col items-center bg-gray-100" style={{ height: '70vh', width: '81vw' }}>
            {!buscado && (
                <div className="my-10">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Ingrese documento del médico:</label>
                    <input
                        type="text"
                        value={documento}
